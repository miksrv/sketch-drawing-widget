[sketch-drawing-widget](../README.md) / [Exports](../modules.md) / [components/sketch-form/components/form-editor](components_sketch_form_components_form_editor.md) / default
